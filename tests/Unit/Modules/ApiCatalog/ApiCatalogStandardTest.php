...
use OxyAI\Modules\ApiCatalog\ApiCatalogStandard;
use OxyAI\Tests\Unit\TestCase;

final class ApiCatalogStandardTest extends TestCase
{
    public function test_exposes_its_identity(): void
    {
        $standard = new ApiCatalogStandard(new ApiCatalogModule());

        self::assertSame('api-catalog', $standard->id());
        self::assertSame('API Catalog', $standard->name());
    ...
    public function test_discover_generate_and_validate_delegate_to_the_owning_module(): void
    {
        ...
        $standard = new ApiCatalogStandard($module);
