...
final class LicenseServiceProviderTest extends TestCase
{
    ...
    public function test_register_registers_the_license_module_everywhere_it_participates(): void
    {
        $app = $this->makeApp();

        $provider = new LicenseServiceProvider($app);
        $provider->register();

        self::assertTrue($app->make(ModuleRegistry::class)->has('license'));
        self::assertTrue($app->make(ValidationService::class)->has('license'));
        self::assertTrue($app->make(GenerationService::class)->has('license'));
    ...
    public function test_register_does_not_register_a_standard(): void
    {
        ...
        self::assertFalse($app->make(StandardsRegistry::class)->has('license'));
    }

    public function test_boot_boots_the_license_module(): void
    {
        $app = $this->makeApp();
        ...
        self::assertTrue($app->make(ModuleRegistry::class)->isBooted('license'));
    }
}
