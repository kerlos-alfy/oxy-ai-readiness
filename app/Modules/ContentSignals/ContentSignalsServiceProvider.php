...
/**
 * Registers the Content Signals module into every engine it participates in.
 *
 * @package OxyAI
 */
 ...
 */
final class ContentSignalsServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        $this->app->make(StandardsRegistry::class)->register(new ContentSignalsStandard($module));
    }

    public function boot(): void
    {
        $this->app->make(ModuleRegistry::class)->boot('content-signals');
    }
}
