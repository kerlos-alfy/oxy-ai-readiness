...
/**
 * Registers the Commerce module into every engine it participates in.
 *
 * @package OxyAI
 */
 ...
 * registered, per ADR-001's ownership table listing Commerce among the
 * modules owning none.
 */
final class CommerceServiceProvider extends ServiceProvider
{
    ...
    {
        $this->app->make(ModuleRegistry::class)->boot('commerce');
    }
}
