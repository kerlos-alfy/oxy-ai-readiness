...
/**
 * Registers the Markdown module into every engine it participates in.
 *
 * @package OxyAI
 */
...
final class MarkdownServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        $this->app->make(StandardsRegistry::class)->register(new MarkdownStandard($module));
    }

    public function boot(): void
    {
        $this->app->make(ModuleRegistry::class)->boot('markdown');
    }
}
