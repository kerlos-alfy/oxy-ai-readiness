...
final class ApiCatalogModule implements ModuleInterface, DiscoveryInterface, ValidatorInterface, GeneratorInterface
{
    ...
    private const ROUTES = [
        ...
        ['method' => 'GET', 'path' => '/commerce'],
        ['method' => 'GET', 'path' => '/commerce/preview'],
        ['method' => 'POST', 'path' => '/commerce/save'],
        ['method' => 'POST', 'path' => '/commerce/validate'],
        ['method' => 'POST', 'path' => '/commerce/reset'],
        ['method' => 'GET', 'path' => '/analytics'],
        ['method' => 'GET', 'path' => '/analytics/preview'],
        ['method' => 'POST', 'path' => '/analytics/save'],
        ['method' => 'POST', 'path' => '/analytics/validate'],
        ['method' => 'POST', 'path' => '/analytics/reset'],
        ['method' => 'GET', 'path' => '/license'],
        ['method' => 'GET', 'path' => '/license/preview'],
        ['method' => 'POST', 'path' => '/license/save'],
        ['method' => 'POST', 'path' => '/license/validate'],
        ['method' => 'POST', 'path' => '/license/reset'],
        ['method' => 'GET', 'path' => '/updater'],
        ['method' => 'GET', 'path' => '/updater/preview'],
        ['method' => 'POST', 'path' => '/updater/save'],
        ['method' => 'POST', 'path' => '/updater/validate'],
        ['method' => 'POST', 'path' => '/updater/reset'],
    ];
