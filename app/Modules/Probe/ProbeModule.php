 ...
 *
 * Also implements GeneratorInterface (Phase 6): generates fixed,
 * deterministic content tied to its own discovered resource, proving
 * the Generation Engine's publish/rollback pipeline end-to-end per the
 * Phase 6 exit criterion ("A generated resource round-trips through
 * Validation before publish; rollback restores prior version").
 */
final class ProbeModule implements ModuleInterface, DiscoveryInterface, ValidatorInterface, GeneratorInterface
{
    ...
    {
        return $type === 'internal-fixture';
    }

    public function generate(): string
    {
        return "# Probe fixture\n\nInternal validation fixture generated by the Probe module. Not user-facing.\n";
    }
}
